 ...
 * serialized PLACED stamp to be meaningful, which is a fixture change rather
 * than a status map change and is not part of this release.
 */
...
function generateQRCode(companyCode: string, category: string, index: number): string {
...
export async function seedDemoData() {
    ...
    const [dubaiWarehouse] = await db
        ...
        .values({
            ...
            city: "Dubai",
            address: "Building 15, Dubai Logistics Park, Jebel Ali Free Zone, Dubai, UAE",
    ...
    const [abuDhabiWarehouse] = await db
        ...
        .values({
            ...
            country: "United Arab Emirates",
            city: "Abu Dhabi",
            address: "Zone 32, Building 8, Mussafah Industrial Area, Abu Dhabi, UAE",
    ...
    const zonesData = [
        // Dubai Warehouse - Premium Brands Section
        {
            ...
            description: "Temperature controlled area for Pernod Ricard premium portfolio",
        },
        {
            warehouse: dubaiWarehouse.id,
            company: pernodRicard.id,
            name: "Zone A2 - Oversized Items",
            description: "Large format displays and installations for Pernod Ricard",
        },
        // Abu Dhabi Warehouse
        {
    ...
    const createdZones = await db.insert(zones).values(zonesData).returning().onConflictDoNothing();
    ...
    const brandsData = [
        // Pernod Ricard Portfolio
        {
            company: pernodRicard.id,
            name: "Absolut Vodka",
            description: "Premium Swedish vodka - iconic bottle design and flavors",
            logoUrl: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400",
        },
        {
            company: pernodRicard.id,
            name: "Jameson Irish Whiskey",
            description: "Triple-distilled Irish whiskey - smooth and balanced",
            logoUrl: "https://images.unsplash.com/photo-1569529465841-dfecdab7503b?w=400",
        },
        {
            company: pernodRicard.id,
            name: "Chivas Regal",
            description: "Luxury blended Scotch whisky - 12, 18, and 25 year expressions",
            logoUrl: "https://images.unsplash.com/photo-1626897505254-e0f811aa9bf7?w=400",
        },
        {
            company: pernodRicard.id,
            name: "Martell Cognac",
            description: "Premium French cognac - oldest of the great cognac houses",
            logoUrl: "https://images.unsplash.com/photo-1618885472179-5e474019f2a9?w=400",
        },
        {
            company: pernodRicard.id,
            name: "Havana Club",
            description: "Authentic Cuban rum - perfect for mojitos and cocktails",
            logoUrl: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400",
        },
    ];
    ...
    const prDubaiZone = createdZones.find(
        (z) => z.company === pernodRicard.id && z.name === "Zone A - Premium Spirits"
    );
    const prDubaiZone2 = createdZones.find(
        (z) => z.company === pernodRicard.id && z.name === "Zone A2 - Oversized Items"
    );

    const absolutBrand = createdBrands.find((b) => b.name === "Absolut Vodka");
    const jamesonBrand = createdBrands.find((b) => b.name === "Jameson Irish Whiskey");
    ...
    const assetsData = [
        ...
        },
        {
            ...
            category: "Glassware",
            images: ["https://images.unsplash.com/photo-1626897505254-e0f811aa9bf7?w=800"],
            trackingMethod: "POOLED",
            totalQuantity: 180,
        ...
        },
        {
            ...
            category: "Glassware",
            images: ["https://images.unsplash.com/photo-1509669803555-fd5fcd4d2c88?w=800"],
            trackingMethod: "POOLED",
            totalQuantity: 120,
    ...
    const absolutBarCounter = createdAssets.find((a) => a.name === "Absolut Premium Bar Counter");
    const absolutStools = createdAssets.find((a) => a.name === "Absolut Branded Bar Stools");
    const absolutBackdrop = createdAssets.find((a) => a.name === "Absolut 3x4m Fabric Backdrop");
    const absolutShotGlasses = createdAssets.find((a) => a.name === "Absolut Shot Glasses Premium");
    const absolutHighballGlasses = createdAssets.find((a) => a.name === "Absolut Highball Glasses");
    const absolutIceBuckets = createdAssets.find((a) => a.name === "Absolut Ice Buckets Stainless");
    ...
    const [order1] = await db
        ...
        .values({
            ...
            venueCity: "Dubai",
            venueAddress: "Riyadh Road, Umm Hurair 2, Dubai, United Arab Emirates",
            venueAccessNotes:
            ...
            invoicePdfUrl: "https://s3.amazonaws.com/pmg-invoices/INV-20241103-001.pdf",
            ...
            truckPhotos: ["https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=800"],
    ...
    const [order5] = await db
        ...
        .values({
            ...
            venueCountry: "United Arab Emirates",
            venueCity: "Dubai",
            venueAddress: "Sheikh Mohammed bin Rashid Boulevard, Downtown Dubai, UAE",
    ...
    const [order6] = await db
        ...
        .values({
            ...
            venueCountry: "United Arab Emirates",
            venueCity: "Dubai",
            venueAddress: "Downtown Dubai, Sheikh Mohammed bin Rashid Boulevard",
            ...
            invoicePdfUrl: "https://s3.amazonaws.com/pmg-invoices/INV-20241204-002.pdf",
    ...
    const [order7] = await db
        ...
        .values({
            ...
            invoicePdfUrl: "https://s3.amazonaws.com/pmg-invoices/INV-20241208-003.pdf",
    ...
    const absolutLightBox = createdAssets.find((a) => a.name === "Absolut LED Light Box 2m");
    if (absolutLightBox) {
        await db
        ...
        await db
            ...
            .values([
                ...
                },
                {
                    ...
                    photos: ["https://images.unsplash.com/photo-1581783898377-1c85bf937427?w=800"],
                    updatedBy: a2Staff2.id,
    ...
    const calculateBlockedPeriod = (eventStart: Date, eventEnd: Date, refurbDays: number = 0) => {
        const PREP_BUFFER = 5;
    ...
    if (order5) {
        ...
        const chivasChairs = createdAssets.find((a) => a.name === "Chivas Regal VIP Lounge Chairs");
    ...
    if (bookingsData.length > 0) {
        await db.insert(assetBookings).values(bookingsData).onConflictDoNothing();
    }
    ...
    console.log(`✅ ${createdAssets.length}+ Realistic Assets with contextual images`);
