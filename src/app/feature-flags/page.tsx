                    ...
                    >
                      ...
                      <TableCell>
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleExpandRow(company.id, company.features)}
                        >
                          <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform ${expandedCompanyId === company.id ? "rotate-180" : ""}`} />
                        </Button>
                      </TableCell>
                    </TableRow>
                          ...
                          <div className="p-4 border-b border-border">
                            <div className="bg-background border border-border rounded-lg p-4 shadow-inner">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                {Object.entries(company.features).map(([featureId, enabled]) => (
                                  <div key={featureId} className="flex items-center gap-2 p-2 border border-border rounded hover:bg-muted/50 transition-colors">
                                    <input
                                      type="checkbox"
                                      id={`feature-${company.id}-${featureId}`}
                                      className="rounded border-input text-primary focus:ring-primary h-4 w-4"
                                      checked={editingFeatures[featureId] || false}
                              ...
                              <div className="flex items-center justify-end gap-3 pt-2 border-t border-border">
                                ...
                                <Button
                                  size="sm"
                                  onClick={() => handleSaveFeatures(company.id)}
                                  disabled={isSaving}
                                  className="font-mono"
                                >
                                  {isSaving ? (
