        ...
        <div className="container mx-auto space-y-6 px-6 py-8">
            <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                    Create workflow definitions, choose the behavior family, and control company
                    enablement from one place.
                </p>
            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    onChange={(event) =>
                                        setForm((prev) => ({
                                            ...prev,
                                            workflow_family: event.target.value,
                                        }))
                                    }
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    onChange={(event) =>
                                        setForm((prev) => ({
                                            ...prev,
                                            status_model_key: event.target.value,
                                        }))
                                    }
                                >
                                    {availableStatusModels.map((statusModel) => (
                                        <option key={statusModel.key} value={statusModel.key}>
                                            {statusModel.label}
                                        </option>
                                    ))}
                                </select>
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="space-y-3">
                                ...
                                {ENTITY_TYPES.map((entityType) => (
                                    ...
                                    >
                                        <Checkbox
                                            checked={form.allowed_entity_types.includes(entityType)}
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2 text-sm">
                                            <label className="flex items-center gap-3">
                                                <Checkbox
                                                    checked={form.requester_roles.includes(role)}
                                                    onCheckedChange={(value) =>
                                                        setForm((prev) => ({
                                                            ...prev,
                            ...
                            <label className="flex items-center justify-between rounded-md border border-border/60 px-3 py-2 text-sm">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) =>
                                        setForm((prev) => ({ ...prev, priority_enabled: checked }))
                                    }
                                />
                            </label>
                            <label className="flex items-center justify-between rounded-md border border-border/60 px-3 py-2 text-sm">
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                ...
                                                platform-level setting for this workflow definition.
                                            </p>
                                        </div>
                                        <div className="grid gap-3 md:grid-cols-2">
