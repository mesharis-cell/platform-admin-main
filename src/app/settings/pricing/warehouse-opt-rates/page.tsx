...
import { Wrench, Edit, Search } from "lucide-react";
    ...
    return (
        <div>
            <AdminHeader
                ...
                description="Manage base operations buy-side rates"
            ...
            >
                <DialogContent className="max-w-2xl max-h-[calc(100vh-10rem)] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle className="font-mono">EDIT COMPANY</DialogTitle>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setFormData({
                                        ...formData,
                                        warehouse_ops_rate: parseFloat(e.target.value),
                                    })
                                }
                                className="font-mono"
                            />
                            <p className="text-xs text-muted-foreground font-mono">
                                Base operations buy-side rate used in pricing (volume × rate)
                            </p>
                        </div>
