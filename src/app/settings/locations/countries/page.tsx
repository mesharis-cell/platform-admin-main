...
import { Plus, Tag, Building2, Edit, Search, Trash2 } from "lucide-react";
    ...
    return (
        <div>
            ...
            <ConfirmDialog
                ...
                description={`Are you sure you want to delete ${confirmDelete?.name}? This will fail if cities are still linked.`}
                confirmText="Delete"
                cancelText="Cancel"
                variant="destructive"
            />
