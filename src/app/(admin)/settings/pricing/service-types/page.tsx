        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <p className="text-muted-foreground text-center py-8">No service types configured</p>
            ) : (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Unit: {service.unit}
                        {service.defaultRate && ` · Default rate: ${service.defaultRate.toFixed(2)} AED`}
                      </p>
                      {service.description && (
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select value={formData.category} onValueChange={(v: ServiceCategory) => setFormData({ ...formData, category: v })}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={selectedService ? handleEdit : handleCreate} disabled={createService.isPending || updateService.isPending}>
              {(createService.isPending || updateService.isPending) ? 'Saving...' : selectedService ? 'Update' : 'Create'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
