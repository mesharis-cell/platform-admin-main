          ...
          {order.pricing && (
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono">{order.pricing.line_items?.catalog_total?.toFixed(2) || '0.00'} AED</span>
              </div>
              <div className="border-t border-border my-2"></div>
              <div className="flex justify-between font-semibold">
                <span>Logistics Subtotal</span>
                <span className="font-mono">{order.pricing.logistics_subtotal?.toFixed(2)} AED</span>
              </div>
            </div>
          )}
      ...
      <Card className="border-blue-500 bg-blue-50 dark:bg-blue-950/20">
        ...
        <CardContent>
          <p className="text-sm text-blue-800 dark:text-blue-200">
            ...
            Once all fabrication is done, the order will automatically move to IN_PREPARATION.
          </p>
        </CardContent>
      </Card>
  ...
  return (
    <>
      ...
      <CancelOrderModal
        ...
        pendingReskinCount={order.reskinRequests?.filter((r: any) => r.status === 'pending').length || 0}
      />
    </>
  )
}
