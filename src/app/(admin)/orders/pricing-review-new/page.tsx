                        ...
                        {data?.data?.map((order: any) => (
                            ...
                            >
                                ...
                                <CardContent className="space-y-4">
                                        ...
                                        <div className="border border-border rounded-md p-4 bg-muted/50">
                                            ...
                                            <div className="flex justify-between text-sm mb-1">
                                                <span className="text-muted-foreground">
                                                    Base Operations (
                                                    {order.pricing.base_operations.volume}m³)
                                                </span>
                                                <span className="font-mono">
                                                    {order.pricing.base_operations.total.toFixed(2)}{" "}
                                                    AED
                                                </span>
                                            </div>
                                            ...
                                            <div className="flex justify-between text-sm mb-1">
                                                <span className="text-muted-foreground">
                                                    Transport ({order.pricing.transport.emirate},{" "}
                                                    {order.pricing.transport.trip_type})
                                                </span>
                                                <span className="font-mono">
                                                    {order.pricing.transport.final_rate.toFixed(2)}{" "}
                                                    AED
                                                </span>
                                            </div>
                                            ...
                                            <div className="flex justify-between text-sm mb-1">
                                                ...
                                                <span className="font-mono font-semibold">
                                                    {order.pricing.logistics_subtotal.toFixed(2)}{" "}
                                                    AED
                                                </span>
                                            </div>
                                            ...
                                            <div className="flex justify-between text-sm mb-1">
                                                <span className="text-muted-foreground">
                                                    Margin ({order.pricing.margin.percent}%)
                                                </span>
                                                <span className="font-mono">
                                                    {order.pricing.margin.amount.toFixed(2)} AED
                                                </span>
                                            </div>
                                    ...
                                    {order.items?.some((item: any) => item.is_reskin_request) && (
                                        <div className="border border-amber-500/30 rounded-md p-4 bg-amber-500/5">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                This order includes rebranding work. Admin will
                                                process rebrand requests and add costs during
                                                approval.
                                            </p>
                                        </div>
                                    )}
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Note: You can add service line items and upgrade vehicle
                                        type in the full order view before submitting.
                                    </p>
                                </CardContent>
                            </Card>
                        ))}
