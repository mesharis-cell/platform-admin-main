...
export function AddCustomLineItemModal({ open, onOpenChange, orderId }: AddCustomLineItemModalProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label>Total Amount (AED) <span className="text-destructive">*</span></Label>
            <Input
              type="number"
              step="0.01"
              min="0"
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-md p-3">
            <p className="text-xs text-blue-800 dark:text-blue-300">
              ℹ️ Custom items are entered as final amounts. The margin you've included in this price will NOT have platform margin applied again.
            </p>
          </div>
        </div>
