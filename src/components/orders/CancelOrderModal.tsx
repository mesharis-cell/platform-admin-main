    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="notes">
              Additional Notes (visible to client) <span className="text-destructive">*</span>
            </Label>
            <Textarea
              id="notes"
              value={notes}
          ...
          <div className="border-t border-border pt-3">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 ml-4 list-disc">
              ...
              {pendingReskinCount > 0 && (
                <li>Cancel {pendingReskinCount} pending reskin request{pendingReskinCount > 1 ? 's' : ''}</li>
              )}
        ...
        <DialogFooter>
          ...
          <Button onClick={handleCancel} variant="destructive" disabled={cancelOrder.isPending}>
