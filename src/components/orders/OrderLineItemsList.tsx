...
export function OrderLineItemsList({ orderId, canManage = false }: OrderLineItemsListProps) {
  ...
  const catalogItems = activeItems.filter((item: OrderLineItem) => item.lineItemType === 'CATALOG')
  ...
  return (
    <div className="space-y-4">
      ...
      {catalogItems.length > 0 && (
        <div>
          <h4 className="text-sm font-semibold mb-2 text-muted-foreground">Catalog Services</h4>
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {item.quantity} {item.unit} × {item.unitRate?.toFixed(2)} AED
                  </p>
                  {item.notes && (
      ...
      {customItems.length > 0 && (
        <div>
          <h4 className="text-sm font-semibold mb-2 text-muted-foreground">Custom Charges</h4>
          <div className="space-y-2">
