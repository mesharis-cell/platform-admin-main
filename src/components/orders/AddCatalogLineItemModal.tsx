...
export function AddCatalogLineItemModal({ open, onOpenChange, orderId }: AddCatalogLineItemModalProps) {
        ...
        <div className="space-y-4">
          ...
          {selectedService && (
            <div className="p-3 bg-muted rounded-md text-sm">
              ...
              <p><strong>Unit:</strong> {selectedService.unit}</p>
              {selectedService.defaultRate && (
                <p><strong>Default Rate:</strong> {selectedService.defaultRate.toFixed(2)} AED</p>
              )}
            </div>
          )}
          ...
          <div>
            <Label>Unit Rate (AED) <span className="text-destructive">*</span></Label>
            <Input
              type="number"
              step="0.01"
              min="0"
          ...
          {calculatedTotal > 0 && (
            <div className="p-3 bg-primary/5 border border-primary/20 rounded-md">
              <p className="text-sm">
                ...
                <span className="font-bold font-mono text-lg">{calculatedTotal.toFixed(2)} AED</span>
              </p>
            </div>
          )}
