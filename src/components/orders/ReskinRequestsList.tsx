    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {pendingReskins.map((reskin: any) => (
          <div key={reskin.id} className="border border-amber-500/30 bg-amber-50/50 dark:bg-amber-950/10 rounded-md p-4">
        ...
        {completedReskins.map((reskin: any) => (
          <div key={reskin.id} className="border border-green-500/30 bg-green-50/50 dark:bg-green-950/10 rounded-md p-4">
        ...
        {cancelledReskins.map((reskin: any) => (
          <div key={reskin.id} className="border border-border bg-muted/30 rounded-md p-4">
            <div className="flex items-center gap-2 mb-2">
