      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <div className="flex justify-between text-sm p-2 bg-muted/30 rounded">
            <span>
              Warehouse Operations ({pricing.base_operations.volume.toFixed(1)} m³ × {pricing.base_operations.rate.toFixed(2)})
            </span>
        ...
        {catalogItems.length > 0 && (
          <div>
            <h4 className="text-sm font-semibold text-muted-foreground mb-2">CATALOG SERVICES</h4>
        ...
        <div className="flex justify-between text-sm p-2 bg-muted/30 rounded">
          ...
          <span className="font-mono font-semibold">{pricing.margin.amount.toFixed(2)} AED</span>
        </div>
        ...
        {customItems.length > 0 && (
          <>
            <div>
              <h4 className="text-sm font-semibold text-muted-foreground mb-2">CUSTOM CHARGES</h4>
              <div className="space-y-1">
                {customItems.map((item) => (
                  <div key={item.id} className="flex justify-between text-sm p-2 bg-amber-50/30 dark:bg-amber-950/10 rounded">
